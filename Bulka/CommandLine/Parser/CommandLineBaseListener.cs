...
public partial class CommandLineBaseListener : ICommandLineListener {
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="CommandLineParser.noop"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterNoop([NotNull] CommandLineParser.NoopContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="CommandLineParser.noop"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitNoop([NotNull] CommandLineParser.NoopContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="CommandLineParser.call"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterCall([NotNull] CommandLineParser.CallContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="CommandLineParser.call"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitCall([NotNull] CommandLineParser.CallContext context) { }
	/// <summary>
