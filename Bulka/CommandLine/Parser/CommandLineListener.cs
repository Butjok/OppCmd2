...
public interface ICommandLineListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterNoop([NotNull] CommandLineParser.NoopContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CommandLineParser.noop"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitNoop([NotNull] CommandLineParser.NoopContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="CommandLineParser.call"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCall([NotNull] CommandLineParser.CallContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CommandLineParser.call"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCall([NotNull] CommandLineParser.CallContext context);
	/// <summary>
